...
def parse_config():
    ...
    # File Config
    parser.add_argument('--config', type=str, default='gradio_demo/config.yaml', is_config_file=True)
    parser.add_argument('--style_img', type=str, required=False)
    parser.add_argument('--mesh', type=str, required=False)
    ...
    parser.add_argument('--ip_adapter_scale', type=float, default=1.0, help='IP Adapter scale factor')
